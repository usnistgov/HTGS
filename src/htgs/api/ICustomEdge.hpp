 ...
 * edges (such as connecting two tasks from two different TaskGraphs) it may be required to inherit
...
class ICustomEdge {
 public:
   ...
   * inheriting the TaskGraph and creates a new type of TaskGraph.
   *

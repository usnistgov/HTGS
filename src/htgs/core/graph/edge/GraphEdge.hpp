...
#ifndef HTGS_GRAPHOUTPUTEDGE_HPP
#define HTGS_GRAPHOUTPUTEDGE_HPP

#include <htgs/core/graph/edge/EdgeDescriptor.hpp>

namespace htgs {
  template <class T>
  class GraphEdge : public EdgeDescriptor {
   public:
    GraphEdge(std::shared_ptr<Connector<T>> graphConnector) : graphConnector(graphConnector) {}
    virtual ~GraphEdge() {}
...
#endif //HTGS_GRAPHOUTPUTEDGE_HPP

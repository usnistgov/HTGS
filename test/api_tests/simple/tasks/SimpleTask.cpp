...
//        std::cout << this->getName() << "(" << this->pipelineId << ")- - ALLOC: Received data for pipeline: " << data->getPipelineId() << " mem id: " << mem->getPipelineId() << std::endl;
        data->setMem(mem);
      }
...
//        std::cout << this->getName() << "(" << this->pipelineId << ")- - RELEASE: Received data for pipeline: " << data->getPipelineId() << " mem id: " << mem->getPipelineId() << std::endl;
      }
    }
    addResult(data);

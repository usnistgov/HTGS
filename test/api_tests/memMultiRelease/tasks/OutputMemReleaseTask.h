...
#ifndef HTGS_OUTPUTMEMRELEASETASK_H
#define HTGS_OUTPUTMEMRELEASETASK_H

#include <htgs/api/ITask.hpp>

class OutputMemReleaseTask : public htgs::ITask<ProcessedData, ProcessedData> {
 ...
 public:
  ...
  virtual std::string getName() override {
    return "OutputMemReleaseTask" + std::to_string(id);
  }

  virtual htgs::ITask<ProcessedData, ProcessedData> *copy() override {
...
#endif //HTGS_OUTPUTMEMRELEASETASK_H
